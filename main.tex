...
The result of this work is a tool that allows us to create questionnaires, which when they get filled in by the representatives of trauma systems or trauma centers create RDF representations based on the meaning of the answer. 
...
this work is the CAFE web application, the source of which is available on Github (https://github.com/cafe-trauma/). 
